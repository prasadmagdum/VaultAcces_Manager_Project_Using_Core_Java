...
Features:User Registration – Users can register by providing details such as ID, Name, Age, and Email. The system auto-generates a unique username and a secure password.Secure Login – Users can log in using their username and password. Credentials are verified for authentication.
